...
import { makeTask, takeTask, task, deleteTask, submitTask, getSubmittedTask, getUserSubmittedTask, countUserTask } from '../controllers/taskControllers.js';
...
router.post('/countUserTask', verifyToken, countUserTask);
