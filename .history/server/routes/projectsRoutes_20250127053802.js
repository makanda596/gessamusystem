...
import { postprojects, getprojects, weeklyProject, getweeklyProjects } from '../controllers/projectControllers.js';
...
router.post('/weekly-projects', weeklyProject)
router.get('/getweekly-projects', upload.single('file'), getweeklyProjects)
