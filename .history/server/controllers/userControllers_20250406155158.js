...
import { sendPasswordResetEmail, sendRestPasswordEmail, sendVerificationEmail } from '../emails/Email.js';
...
export const signup = async (req, res) => {
    ...
    try {
        ...
        const verificationToken = crypto.randomBytes(2).toUpperCase().toString("hex")
        ...
        const user = new User({
            ...
            verificationTokenExpiresA: verificationTokenExpiresAt,
            phoneNumber,
