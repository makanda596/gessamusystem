...
import { sendConfirmationEmail, sendPasswordResetEmail, sendRestPasswordEmail, sendVerificationEmail } from '../emails/Email.js';
...
export const verifyEmail = async(req,res)=>{
    const {code} = req.body
    const email = "makandabrian2002@gmail.com"; // Ensure this variable holds the email address
