...
import { weeklyProjects } from '../models/weeklyProjects.js';  // Ensure the correct import path for the schema

export const weeklyProject = async (req, res) => {
    const { title, trainer, description, reference1, reference2, reference3, date } = req.body;
