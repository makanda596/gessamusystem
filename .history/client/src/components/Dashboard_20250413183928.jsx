            ...
            <div className="w-full bg-white p-8 rounded-lg shadow-2xl max-w-6xl text-center">
                ...
                {user && (
                    <div className="flex flex-col items-center">
                        ...
                        <div className="mt-6 w-full h-auto grid grid-cols-3 gap-4">
                            <div className="bg-blue-100 p-2 rounded-lg shadow-md">
                              <UserProjectCount/>
                            </div>
                            <div className="bg-white-100 p-2 rounded-lg shadow-md">
                                <TaskCount/>
                            </div>
                            <div className="bg-yellow-100 p-2 rounded-lg shadow-md">
                                <h4 className="text-lg font-semibold text-gray-700">Alerts</h4>
                                <p className="text-xl font-bold text-yellow-600">{alerts.length}</p>
                            </div>
                        </div>
