...
const SubmitProject= ({ setIsPopup, isPopup }) => {
    ...
    return (
        <div className={`fixed inset-0 z-50 ${isPopup ? 'block' : 'hidden'}`}>
            ...
            <div className="absolute top-70 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-md p-6">
                <form
                    onSubmit={handleSubmit}
                    className="bg-white rounded-xl shadow-2xl p-2 space-y-2"
