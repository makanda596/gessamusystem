using this code import { useState } from "react";
    ...
    <nav className="bg-gradient-to-r from-blue-500 to-green-500 p-4 shadow-md">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <ul className="hidden md:flex space-x-6 text-white font-medium">
          ...
          <li className="flex items-center space-x-1 cursor-pointer hover:opacity-80">
            <FaCog /> <a href='/setting'>Settings</a>
          </li>
        </ul>

        {/* Icons & Mobile Menu Button */}
        <div className="flex items-center space-x-6 text-white">
          <FaBell className="text-xl cursor-pointer hover:opacity-80" href='/alert'/>
...
export default Navbar;  ,make a popup when one opnes the user icon the popup should include the profile and logout