...
const TaskCount = () => {
    ...
    return (
        <div className="p-2 bg-white dark:bg-gray-900 rounded-xl shadow-md w-full max-w-xl mx-auto">
            <h2 className="text-xl font-bold mb-4 text-gray-800 dark:text-white">📊 Task Overview</h2>
