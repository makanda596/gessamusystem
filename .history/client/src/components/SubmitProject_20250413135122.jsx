...
const SubmitProject= ({ setIsPopup, isPopup }) => {
    ...
    return (
        <div className={`fixed inset-0 z-50 ${isPopup ? 'block' : 'hidden'}`}>
            ...
            <div className="absolute top-72 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-md p-6">
                <form
                    onSubmit={handleSubmit}
                    className="bg-white rounded-xl shadow-2xl px-2 space-y-0"
                    onClick={(e) => e.stopPropagation()}
                >
                    <div className="flex justify-between items-center pb-2 border-b border-gray-200">
                        <h2 className="text-xl font-bold text-gray-900">Submit New Project</h2>
                        <button
                            type="button"
                    ...
                    <div className="space-y-2">
                        <div>
                            ...
                            <label
                                ...
                                className={`block w-full h-30 border-2 border-dashed rounded-xl cursor-pointer transition-colors
                            ...
                            >
                                {image ? (
                                    <>
                                        ...
                                        <div className="max-h-40  flex flex-col items-center justify-center text-center">
                        ...
                        <div className="space-y-2">
                            ...
                            <div>
                                ...
                                <input
                                    type="text"
                                    name=" resource"
                                    placeholder="please only one resource"
                    ...
                    <div className="flex gap-2">
                        <button
                            type="button"
                            onClick={() => setIsPopup(false)}
                            className="flex-1 py-2 px-6 rounded-lg font-medium text-gray-700 bg-gray-100 border-2 border-gray-400 hover:bg-gray-200"
                            disabled={loading}
                        >
                            Cancel
                        </button>
                        <button
                            type="submit"
                            className={`flex-1 py-2 text-md px-6 rounded-lg font-medium text-white transition-colors flex items-center justify-center
