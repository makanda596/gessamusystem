    ...
    <nav className="bg-gradient-to-r from-blue-500 to-green-500 p-2 shadow-md relative">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <ul className="hidden md:flex space-x-6 text-white font-medium">
          ...
          <li className="text-black">{alerts ||"no alerts"}</li>
          <li>
          ...
          <li>
            <a href="/trainings" className="flex items-center space-x-1 hover:text-black">
              <FaProjectDiagram /> <span>Trainings</span>
            </a>
          </li>
          <li>
