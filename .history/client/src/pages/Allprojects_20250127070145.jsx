...
const Allprojects = () => {
    ...
    const handleSearch = async () => {
        ...
        setLoading(true);
        try {
            const response = await axios.get(`http://localhost:5000/projects/search?query=${searchTerm}`);
            setProjects(response.data);
        } catch (error) {
    ...
    return (
        <div className="flex">
            ...
            <div className="flex-1 p-8 bg-gray-50 min-h-screen">
                ...
                {/* Search Bar and Button Centered */}
                <div className="flex justify-center items-center mb-6">
                    <input
                        ...
                        className="border border-gray-300 p-2 rounded-lg text-black mr-2"
                    />
                    <button
