            ...
            <div className="min-h-screen bg-gray-50 p-2 md:p-8">
                <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-6">
                    <div className="flex justify-between items-center mb-4">
                        <h1 className="text-xl font-bold text-gray-900">Try some Task and submit for review</h1>
...
const TaskCard = ({ task, showNotification, setIsPopup }) => {
    ...
    return (
        <div className="relative group bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-200 ease-out border border-gray-100">
            <div className="p-1  border-gray-300 border-2">
