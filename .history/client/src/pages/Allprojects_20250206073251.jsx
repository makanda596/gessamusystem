                        ...
                        <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                            {currentProjects.length > 0 ? (
                                currentProjects.map((project, index) => (
                                    <div
                                        key={index}
                                        className="mb-4 p-2 border bg-gray-200 border-gray-200 rounded-lg shadow-md gap-4"
                                    >
                                        <h2 className="text-lg font-semibold text-black  p-1 rounded-md hover:bg-green-500 transition-colors duration-300">
