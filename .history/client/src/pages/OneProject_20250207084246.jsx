    ...
    return (
        <div className="container mx-auto px-6 py-8">
            ...
            <div className="flex flex-col lg:flex-row lg:space-x-8">
                ...
                <div className="lg:w-2/3 bg-blue-50 p-8 rounded-lg shadow-lg border border-blue-300">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="mt-4">
                            ...
                            <p className="text-md text-black font-bold m-4">
                                Link:{""}
                                <a href={project.reference} target="_blank" rel="noreferrer" className="text-black-600 font-sans underline hover:text-green-600 m-4">
                                    {project.reference}                          </a>
                            </p>
                        </div>
                ...
                <div className="lg:w-1/3 bg-white-600 p-6 rounded-lg shadow-md border border-gray-300">
                        ...
                        <ul className="space-y-4">
                            {weeklyProjects.map((proj) => (
                                ...
                                >
                                    ...
                                    />
                                    <div>
                                        <a href={`/project/${project._id}`} target="_blank" rel="noreferrer" className="hover:underline text-md font-semibold text-blue-600 cursor-pointer">
                                            {project.title}
                                        </a>
