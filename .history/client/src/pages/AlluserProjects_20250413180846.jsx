        ...
        {allProjects.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {allProjects.map((project) => (
              <div
                key={project._id}
                className="bg-gray-200 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 border border-gray-200 overflow-hidden flex flex-col"
              >
                ...
                <div className="p-6 flex-grow">
                  <a href={`/project/${project._id}`} className="text-xl font-semibold text-gray-900 mb-3 line-clamp-2">
                    {project.title}
                  </a>
