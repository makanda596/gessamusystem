                            ...
                            currentProjects.map((project, index) => (
                                ...
                                >
                                    ...
                                    <p className="text-md text-black font-bold">
                                        Link:{" "}
                                        <a href="https://www.youtube.com/feed/history" target="_blank" rel="noreferrer" className="text-blue-600 font-sans underline hover:text-green-600">
                                            "https://www.youtube.com/feed/history"<a/>
                                    </p>
                                    <p className="text-md text-black font-bold">
