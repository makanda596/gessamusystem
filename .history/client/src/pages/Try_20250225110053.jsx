  ...
  return (
    <>
      ...
      <nav className="bg-green-800 p-2 px-4 text-white flex items-center justify-between relative shadow-lg z-40">
        <a
          href="mailto:gessamusuport@gmail.com"
          target="_blank"
          ...
          <div className="relative">
            ...
            {isDropdownOpen && (
              <div className="absolute right-0 mt-2 bg-white text-black p-3 rounded-lg shadow-lg w-40">
                <ul>
                  <a href="/profile" className="py-1 px-4 hover:bg-gray-200 cursor-pointer">
                    My Profile
                  </a>
      ...
      <div
        className={`z-40 fixed top-0 left-0 h-full w-64 bg-green-900 text-white p-5 pt-14 transform ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"
      ...
      >
        ...
        {/* Mobile Navigation */}
        <nav className="flex flex-col space-y-4 mt-6 z-40">
          ...
          <button onClick={logoutHandle} className="text-red-500 mt-1 font-bold text-xl hover:underline">
            Logout
          </button>
        </nav>
      </div>
