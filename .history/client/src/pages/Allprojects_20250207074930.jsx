...
const Allprojects = () => {
  ...
  Link:{" "}
  <a
    href={project.reference?.trim().startsWith("http") ? project.reference.trim() : `https://${project.reference.trim()}`}
    target="_blank"
    rel="noreferrer"
    className="text-blue-600 font-sans underline hover:text-green-600"
  >
    {project.reference}
  </a>
</p>
