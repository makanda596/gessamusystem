...
import { LockClosedIcon, ArrowRightIcon, ReloadIcon } from '@radix-ui/react-icons';
        ...
        <div className="min-h-screen bg-gradient-to-br from-purple-50 to-blue-50 flex items-center justify-center p-4">
            ...
            >
                <div className="text-center space-y-4">
                    <div className="inline-flex items-center justify-center bg-purple-100 rounded-full p-4">
                    ...
                    <div className="text-center text-sm text-gray-600">
                        ...
                        <button
                            ...
                            className={`mt-2 text-purple-600 font-medium ${
                                !canResend ? 'text-gray-400 cursor-default' : 'hover:text-purple-700'
