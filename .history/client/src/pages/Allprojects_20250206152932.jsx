                        ...
                        {currentProjects.length > 0 ? (
                            currentProjects.map((project, index) => (
                                ...
                                >
                                    ...
                                    {project.reference && Array.isArray(project.reference) && project.reference.length > 0 ? (
                                        project.reference.slice(0, 3).map((ref, idx) => (
                                            <p key={idx} className="text-md text-black font-bold">
                                                Reference {idx + 1}:{" "}
                                                <a href={ref} target="_blank" rel="noreferrer" className="text-blue-600 font-sans underline hover:text-green-600">
                                                    {ref}
                                                </a>
                                            </p>
                                        ))
                                    ) : (
                                        <p className="text-md text-black font-bold">No references available.</p>
                                    )}
