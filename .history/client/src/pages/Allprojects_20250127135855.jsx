                            ...
                            {currentProjects.length > 0 ? (
                                currentProjects.map((project, index) => (
                                    ...
                                    >
                                        ...
                                        <p className="text-md font-boldtext-black  font-bold">Date: </p>
                                        <p className="text-sm text-gray-500">Date: <span className='text-red-700'>{new Date(project?.createdAt).toLocaleDateString()}</span></p>
                                    </div>
