...
const AdminDashboard = () => {
    ...
    const adminLogin = async (email, password) => {
        ...
        try {
            ...
            setAdminEmail(admin.email); // Save admin email after login
            setIsLoading(false);
            // You can also store other admin details if needed
        } catch (error) {
    ...
    // Example login handler (for testing purposes)
    const handleLogin = () => {
        const email = 'admin@example.com';  // Replace with actual email input
