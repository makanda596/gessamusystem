            ...
            <div className="w-64 bg-white shadow-lg p-4">
                ...
                <nav>
                    <ul className="space-y-2">
                        <li>
                            <button onClick={() => setActiveSection('dashboard')} className="w-full text-left px-4 py-2 rounded-lg hover:bg-gray-100">Dashboard</button>
                        </li>
                        <li>
                            <button onClick={() => setProjectDropdown(!projectDropdown)} className="w-full flex justify-between items-center px-4 py-2 rounded-lg hover:bg-gray-100">
                                Projects {projectDropdown ? <ChevronUp size={16} /> : <ChevronDown size={16} />}
                            </button>
                            {projectDropdown && (
                        ...
                        <li>
                            <button onClick={() => setTaskDropdown(!taskDropdown)} className="w-full flex justify-between items-center px-4 py-2 rounded-lg hover:bg-gray-100">
                                Tasks {taskDropdown ? <ChevronUp size={16} /> : <ChevronDown size={16} />}
                            </button>
                            {taskDropdown && (
                                <ul className="pl-4 mt-2 space-y-1">
                        ...
                        <li>
                            <button onClick={() => setQuizDropdown(!quizDropdown)} className="w-full flex justify-between items-center px-4 py-2 rounded-lg hover:bg-gray-100">
                                Quiz {quizDropdown ? <ChevronUp size={16} /> : <ChevronDown size={16} />}
                            </button>
                            {quizDropdown && (
                                <ul className="pl-4 mt-2 space-y-1">
                        ...
                        <li>
                            <button onClick={() => setActiveSection('users')} className="w-full text-left px-4 py-2 rounded-lg hover:bg-gray-100">Users</button>
                        </li>
                    </ul>
                </nav>
            </div>
