            ...
            <div className="w-64 bg-white shadow-lg p-4">
                ...
                <nav>
                    <ul className="space-y-2">
                        ...
                        <li>
                            <button onClick={() => setProjectDropdown(!projectDropdown)} className="w-full text-left px-4 py-2 rounded-lg hover:bg-gray-100">Projects</button>
                            {projectDropdown && (
                        ...
                        <li>
                            <button onClick={() => setTaskDropdown(!taskDropdown)} className="w-full text-left px-4 py-2 rounded-lg hover:bg-gray-100">Tasks</button>
                            {taskDropdown && (
                                <ul className="pl-4 mt-2 space-y-1">
