...
const PostProject = () => {
    ...
    return (
        <div className="flex min-h-screen bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 p-6">
            <div className="w-2/3"></div> {/* Empty left side */}
            <div className="w-1/3 bg-white shadow-lg rounded-lg p-6 transform transition-all hover:scale-105">
