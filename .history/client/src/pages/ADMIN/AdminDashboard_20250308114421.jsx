...
const AdminDashboard = () => {
    ...
    useEffect(() => {
        const fetchStudentCount = async () => {
            try {
                const response = await axios.get("https://gessamusystem.onrender.com/auth/studentCount");
    ...
    const fetchWeeklyCount = async () => {
        try {
            const response = await axios.get("https://gessamusystem.onrender.com/projects/countWeekly")
    ...
    const fetchTotalCount = async () => {
        try {
            const response = await axios.get("https://gessamusystem.onrender.com/projects/countProject")
