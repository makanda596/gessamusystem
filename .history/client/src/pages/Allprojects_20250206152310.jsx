                        ...
                        {currentProjects.length > 0 ? (
                            currentProjects.map((project, index) => (
                                ...
                                >
                                    ...
                                    {project.references && project.references.slice(0, 3).map((ref, idx) => (
                                        <p key={idx} className="text-md text-black font-bold">
                                            Reference {idx + 1}:{" "}
                                            <a href={ref.references} target="_blank" rel="noreferrer" className="text-blue-600 font-sans underline hover:text-green-600">
                                                {ref}
                                            </a>
                                        </p>
                                    ))}
