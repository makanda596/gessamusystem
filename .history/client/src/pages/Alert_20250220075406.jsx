...
const Alert = ({ userId }) => {
    ...
    if (loading) {
        return <div className="flex justify-center items-center h-32 text-gray-600 text-lg font-medium">  <div className="flex items-center justify-center min-h-screen">
