...
const Navbar = ({ userId }) => {
  ...
  return (
    <>
      ...
      <div
        className={` fixed top-0 right-0 h-full w-96 bg-green-900 text-white p-5 pt-14 transform transition-transform duration-300 ease-in-out shadow-lg lg:hidden ${isSidebarOpen ? "translate-x-0" : "translate-x-full"
          }`}
      >
        ...
        {/* Mobile Navigation */}
        <nav className="flex flex-col space-y-4 mt-6 text-lg cursor-pointer">
          <a href="/dashboard" className=" cursor-pointer hover:text-gray-300  transition duration-300 ease-in-out hover:underline">Home</a>
          <a href="/projects" className="cursor-pointer hover:text-gray-300  transition duration-300 ease-in-out hover:underline">Projects</a>
          <a href="/trainings" className="cursor-pointer hover:text-gray-300  transition duration-300 ease-in-out hover:underline">Trainings</a>
          <a href="/settings" className="cursor-pointer hover:text-gray-300  transition duration-300 ease-in-out hover:underline">Settings</a>
          <a href="/task" className="cursor-pointer hover:text-gray-300  transition duration-300 ease-in-out hover:underline">Tasks</a>
