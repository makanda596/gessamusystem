                        ...
                        <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                            {currentProjects.length > 0 ? (
                                currentProjects.map((project, index) => (
                                    <div
                                        key={index}
                                        className="mb-6 p-6 border bg-gray-200 border-gray-200 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 ease-in-out transform hover:scale-105"
                                    >
                                        ...
                                        <p className="text-black mt-2">
                                            {project.description.length > 50 ? project.description.slice(0, 30) + '...' : project.description}
                                        </p>
                                        ...
                                        <p className="text-md text-green-600">Trainer: {project.trainer}</p>
                                        <p className="text-md font-bold text-red-600">Date: {project.date}</p>
                                    </div>
