...
const Navbar = ({ userId }) => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-0 right-0 h-full w-full bg-green-900 text-white p-5 pt-14 transform transition-transform duration-300 ease-in-out shadow-lg lg:hidden ${
