            ...
            <div className="flex p-6 bg-gray-50 h-screen overflow-hidden">
                <div className="flex-1 overflow-y-auto">
                    <div className="flex justify-between items-center mb-6">
                        ...
                        <div className="relative flex items-centerw-full max-w-sm">
                            ...
                            {showInput && (
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full pl-3 pr-16 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
                                    />
                        ...
                        <button
                            ...
                            className="bg-blue-500 text-md text-white px-1 py-1 rounded-md hover:bg-blue-600"
                        >
                            Post  Project
                        </button>
                    </div>
