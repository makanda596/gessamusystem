...
const AllProjects = () => {
    ...
    return (
        <>
            <Navbar />
            <div className="flex flex-col lg:flex-row p-4 lg:p-6 bg-gray-50 min-h-screen overflow-hidden">
                {/* Main Section (Projects) */}
                <div className="flex-1 overflow-y-auto lg:pr-4">
                    <div className="flex flex-col lg:flex-row justify-between items-center mb-6">
                        <h1 className="text-2xl lg:text-3xl font-bold mb-4 lg:mb-0">All Projects</h1>
                        <button
                    ...
                    <div className="flex flex-col lg:flex-row mb-6">
                        <input
                            ...
                            className="border border-gray-300 p-2 rounded-md w-full lg:w-1/2 text-black mb-2 lg:mb-0"
                        />
                        <button onClick={handleSearch} className="bg-blue-500 text-white p-2 lg:ml-2 rounded-md hover:bg-blue-600">
                            Search
                        </button>
                    </div>
                ...
                {/* Right Section (Recently Posted Projects) - Hidden on Small Screens */}
                <div className="hidden lg:block w-full lg:w-1/3 p-4 border-l border-gray-300 bg-white shadow rounded-lg">
            ...
            {showForm && (
                <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-50">
                    <div className="bg-white p-6 rounded-md shadow-lg w-11/12 lg:w-1/2">
