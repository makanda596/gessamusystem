                ...
                <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                    ...
                    <div className="relative">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 px-6 py-8 text-white">
                            <h1 className="text-3xl md:text-4xl font-bold mb-2">{project.userId.email}</h1>
                            <h1 className="text-3xl md:text-4xl font-bold mb-2">{project.userId.firstName} {project.userId.lastName}</h1>
