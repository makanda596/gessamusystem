                ...
                <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                    ...
                    <div className="px-2 py-2 md:px-10 md:py-12">
                        ...
                        <div className="space-y-2">
                            <div>
                                <h2 className="text-xl font-semibold text-gray-800 mb-2 underline">Project Title</h2>
                                <div className="prose max-w-none text-gray-600 leading-relaxed">
                                    {project.title}
                                </div>
                            </div>
                            <div>
                                <h2 className="text-xl font-semibold text-gray-800 mb-2 underline">Project Description</h2>
                                <div className="prose max-w-none text-gray-600 leading-relaxed">
                                    {project.description}
                                </div>
                            </div>
