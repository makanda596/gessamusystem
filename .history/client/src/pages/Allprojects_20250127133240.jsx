                        ...
                        <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                            {currentProjects.length > 0 ? (
                                currentProjects.map((project, index) => (
                                    <div
                                        key={index}
                                        className="mb-4 p-2 border bg-gray-200 border-gray-200 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 ease-in-out transform hover:scale-105"
                                    >
                                        <h2 className="text-2xl font-semibold text-black bg-blue-400 p-2 rounded-md hover:bg-green-500 transition-colors duration-300">
                                        ...
                                        <img
                                            ...
                                            className="mt-4 w-full h-56 object-cover rounded-md transition-transform duration-300 ease-in-out transform hover:scale-105"
                                        />
                                        ...
                                        <p className="text-md text-black  font-bold">
                                            Link:{" "}
                                            <a href={project.reference} target="_blank" rel="noreferrer" className="text-blue-600 font-sans underline">
                                                {project.reference}
                                            </a>
                                        </p>
                                        <p className="text-md text-black  font-bold">Trainer:  <span className='text-green-600 text-xl font-bold'>{project.trainer}</span> </p>
                                        <p className="text-md font-boldtext-black  font-bold">Date: <span className='text-red-700'>{project.date}</span></p>
                                    </div>
