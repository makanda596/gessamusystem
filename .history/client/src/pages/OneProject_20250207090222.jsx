    ...
    return (
        <div className="container mx-auto px-6 py-8">
            ...
            <div className="flex flex-col lg:flex-row lg:space-x-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="mt-4">
                            ...
                            <div className="flex items-center space-x-2">
                                <a href={project.reference} target="_blank" rel="noreferrer" className="text-black-600 underline hover:text-green-600">
                                    {project.reference}
                                </a>
                                <button
                ...
                <div className="lg:w-1/3 bg-white p-6 rounded-lg shadow-md border border-gray-300">
                        ...
                        <ul className="space-y-4">
                            {weeklyProjects.map((proj) => (
                                <li key={proj._id} className="flex items-center space-x-4 bg-white p-4 rounded-lg shadow-sm border border-gray-200 hover:bg-gray-100">
                                    ...
                                    <button
                                        onClick={() => navigator.share ? navigator.share({ title: proj.title, url: `/project/${proj._id}` }) : navigator.clipboard.writeText(window.location.origin + `/project/${proj._id}`)}
