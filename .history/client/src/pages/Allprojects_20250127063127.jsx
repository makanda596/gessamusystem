    ...
    return (
        <div className="flex">
            ...
            <div className="w-64 bg-gray-800 text-white min-h-screen p-4">
                ...
                <ul>
                    <li className="mb-4">
                        {/* Displaying Projects on the Same Page */}
                        <button
                            onClick={() => setYearSubmitted(false)}
            ...
            <div className="flex-1 p-8 bg-gray-50 min-h-screen">
                ...
                {/* Display Projects based on Year Submitted */}
                {yearSubmitted ? (
                    ...
                    <div className="mt-6">
                        {/* Optionally, you can show some default content here */}
                        <p>Select a year to view the projects or click "View All Projects" to display them.</p>
                    </div>
                )}
            </div>
        </div>
