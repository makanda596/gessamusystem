...
const Emailverification = () => {
    ...
    useEffect(() => {
        ...
        if (!email && storedEmail) {
            useAuthStore.setState({ email: storedEmail }); // sync to Zustand if needed
        }
                ...
                <div className="max-w-md w-full space-y-8">
                    <div>
                        ...
                        <p className="mt-2 text-center text-sm text-gray-600">
                            Enter the verification code sent to your email address,.If you didnt see your email please check your spam or promotion folder
                        </p>
                    </div>
