                            ...
                            currentProjects.map((project, index) => (
                                ...
                                >
                                    ...
                                    <p className="text-sm text-black font-bold">
                                        Done by: <span className="text-green-600 text-md font-semibold">{project.trainer}</span>
                                    </p>
                                    <p> <a href="mailto:gessamusuport@gmail.com" target="_blank"
                                        rel="noopener noreferrer" className="text-blue-600">Email :gessamusuport@gmail.com</a></p>
                                </div>
                            ))
                        ) : (
