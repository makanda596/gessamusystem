    ...
    return (
        <>
            ...
            <div className="flex p-6 bg-gray-50 h-screen overflow-hidden">
                <div className="flex-1 overflow-y-auto">
                    <div className="flex justify-between items-center mb-6">
                        ...
                        <div className="relative flex items-center">
                            ...
                            {/* Search Input (conditionally displayed) */}
                            {showInput && (
                                <input
                                    type="text"
                                    placeholder="Search..."
                                    ...
                                    className="ml-2 px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
                                />
                            )}
                            ...
                            {showInput && (
                                <button
                                    ...
                                    className="bg-blue-500 text-white px-2 py-1 ml-2 rounded-md hover:bg-blue-600 transition-all"
                                >
                                    Search
                                </button>
                            )}
                        ...
                        <button
                            ...
                            className="bg-blue-500 text-md text-white px-2 py-2 rounded-md hover:bg-blue-600"
                        >
                            Post a Project
                        </button>
                    </div>
                    ...
                    {loading ? (
                        <div className="flex justify-center items-center">
                            <div className="w-16 h-16 border-4 border-t-red-600 border-b-green-600 border-l-red-600 border-r-red-600 rounded-full animate-spin"></div>
                        </div>
                    ) : (
                ...
                <div className="w-1/3 p-4 border-l border-gray-300 bg-white shadow rounded-lg hidden sm:block">
