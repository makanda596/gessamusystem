...
const USER_API = "https://gessamubackend-zrou.onrender.com/auth";
...
export const useAuthStore = create((set) => ({
    ...
    signup: async (firstName, lastName, email, phoneNumber, password, avatar) => {
        ...
        try {
            const response = await axios.post('https://gessamubackend-zrou.onrender.com/signup', { firstName, lastName,  email, phoneNumber, password, avatar });
    ...
    adminLogin: async (email, password) => {
        set({ isLoading: true, error: null });
        try {
            const response = await axios.post('https://gessamubackend-zrou.onrender.com/adminLogin', { email, password });
    ...
    logout: async () => {
        try { 
            await axios.post('https://gessamubackend-zrou.onrender.com/auth/logout', null, { withCredentials: true });
    ...
    checkAuth: async () => {
        ...
        try {
            ...
            const response = await axios.get('https://gessamubackend-zrou.onrender.com/auth/check-auth', {
