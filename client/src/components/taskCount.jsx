            ...
            <div className="grid grid-cols-2 gap-4" >
                <div className="bg-blue-100 dark:bg-blue-900 p-2 rounded-xl flex items-center gap-2 shadow-sm">
                    <div>
                        ...
                        <p className="text-xl font-semibold text-gray-900 dark:text-white">{totalTasks || "0"}</p>
                    </div>
                </div>
                <div className="bg-green-400 dark:bg-green-900 p-2 rounded-xl flex items-center gap-2 shadow-sm">
                    <div>
                        <p className="text-sm text-gray-600 dark:text-gray-300">Completed</p>
                        <p className="text-xl font-semibold text-gray-900 dark:text-white">{completedTasks || "0"}</p>
                    </div>
                </div>
            </div>
