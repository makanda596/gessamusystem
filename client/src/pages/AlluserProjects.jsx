      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 p-0 md:p-8">
        <div className="max-w-7xl mx-auto">
          <div className="flex justify-between items-center mb-8 p-2">
            <div>
              <h1 className="text-xl font-bold text-gray-900">Posted Projects</h1>
                ...
                >
                  <div className="p-4 bg-gray-50 border-b border-gray-100">
                    <div className="flex items-center">
                      {project?.userId?.avatar ? (
                        ...
                        <div className="w-10 h-10 rounded-full mr-3 border-2 border-gray-300 bg-gray-200 flex items-center justify-center text-gray-600 text-sm">
                          ?
                        </div>
                      )}
                      <div className="flex-1">
                        {project?.userId ? (
                          ...
                          <div className="text-sm text-gray-500 italic">Unknown user</div>
                        )}
                      </div>
                  ...
                  <div className="p-3 flex-grow">
                    ...
                    <p className="text-gray-600 text-md mb-3">
                      ...
                      {project.description.length > 40 ? (
                        <span>{project.description.slice(0, 40)}...</span>
                      ) : (
                  ...
                  <div className="px-4 py-3 bg-gray-50 border-t border-gray-100">
                    <Link
                      ...
                      className="w-full text-indigo-600 text-sm font-medium flex items-center justify-center hover:text-indigo-800 transition-colors"
                    >
